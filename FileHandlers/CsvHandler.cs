...
namespace dchv_api.FileHandlers
{
    ...
    {
        public TableMeta ReadFromFile(string pathToFile, string rowSeparator = ";", string colDelimeter = "\r\n")
        {
            string data;
            try {
        ...
        public TableMeta ReadFromString(string data, string rowSeparator = ";", string colDelimeter = "\r\n")
        {
            ...
            return new TableMeta{ Columns = cols };
        }
    }
}